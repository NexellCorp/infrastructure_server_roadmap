...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Component.engineering_project'
        db.add_column(u'roadmap_component', 'engineering_project',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='engineering_component', unique=True, null=True, to=orm['roadmap.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Component.engineering_project'
        db.delete_column(u'roadmap_component', 'engineering_project_id')
